...
layui.define(['code', 'element', 'table', 'util'], function(exports){
  ...
  //示例页面滚动
  $('.site-iminit-body').on('scroll', function(){
  ...
  //演示页面
  $('body').on('keydown', '#LAY_editor, .site-iminit-text', function(e){
    var key = e.keyCode;
  ...
  //让导航在最佳位置
  var thisItem = $('.site-iminit-nav').find('dd.layui-this');
  if(thisItem[0]){
  ...
  $(function(){
    ...
    DemoCode.val([
      ...
      ,'<body>'
      ,global.preview
      ,'\n<script src="#assets('//res.layui.com/layui/dist/layui.js" charset="utf-8')"></script>'
